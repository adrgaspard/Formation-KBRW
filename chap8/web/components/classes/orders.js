...
var Orders = createReactClass({
  ...
  render() {
    return (
      <JSXZ in="orders" sel=".orders-container">
        <Z sel=".search-orders">
          {
        ...
        <Z sel=".table-lines">
          {this.state.value.map((order) => (
            <JSXZ in="orders" sel=".table-line" key={order.id}>
              ...
              <Z sel=".quantity">
                {this.computeQuantitiesRiak(
                  order["custom.items.quantity_to_fetch"]
                )}
              </Z>
              <Z sel=".details">
                <a href={"/order/" + order.id}></a>
              </Z>
              <Z sel=".delete" onClick={() => this.onClickMode(order.id)}>
                <a href="#"></a>
              </Z>
          ...
          <div class="w-row">
            <div class="w-col w-col-2">
              <div
                ...
                onClick={() => this.onClickChangePage(0)}
              >
                <a href="#">1</a>
              </div>
            </div>
            <div class="w-col w-col-2">
              <div
                class="pagination-link"
                onClick={() => this.onClickChangePage(1)}
              >
                <a href="#">2</a>
              </div>
            </div>
            <div class="w-col w-col-2">
              <div
                class="pagination-link"
                onClick={() => this.onClickChangePage(2)}
              >
                <a href="#">3</a>
              </div>
            </div>
            <div class="w-col w-col-2">
              <div
                class="pagination-link"
                onClick={() => this.onClickChangePage(3)}
              >
                <a href="#">4</a>
              </div>
            </div>
